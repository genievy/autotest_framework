...
class DropDownPageElements:
    ...
    FACULTIES_MENU = (By.CSS_SELECTOR, "li[class*='expanded']:nth-child(3)>ul")
    CENTERS = (By.CSS_SELECTOR, "li[class*='expanded']:nth-child(4)")
    CENTERS_MENU = (By.CSS_SELECTOR, "li[class*='expanded']:nth-child(4)>ul")
...
class DropDownPageLocators:
    ...
    FACULTIES: str = "[class*='menu nav']>li:nth-child(3)"
    CENTERS: str = "[class*='menu nav']>li:nth-child(4)"
